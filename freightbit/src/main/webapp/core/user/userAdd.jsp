                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <s:textfield required="true" name="user.userName" id="uUserName" cssClass="userAddForm form-control" maxlength="25" pattern="(?!^[0-9]*$)(?!^[a-zA-Z]*$)([a-zA-Z0-9]{3,})"
    ...
    $(document).ready(function(){
        ...
        $("#userTypeSelect").change(function() {
            if (this.value == "ADMIN") {
                ...
                $("#permissionsSelected-1").prop("checked", true).prop("disabled", true);
            } else {
