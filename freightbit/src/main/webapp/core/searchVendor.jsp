            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="table-responsive list-table">
                        <s:form cssClass="form-horizontal" action="searchValidation" theme="bootstrap">


                        <div class="form-group">

                            <label for="search" class="col-sm-2 control-label">Search by:</label>

                            <div class="col-sm-10">
                                <s:select list="statuslist" cssClass="form-control" name="search"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield cssClass="form-control" placeholder="Keyword" name="keyword"/>
                            </div>
