					...
					<div class="panel booking panel-info">
					  ...
					  <div class="panel-body">
						<div class="table-responsive list-table">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td class="tb-font-black">
									<a href="permissions-edit" class="icon-action-link"><img src="includes/images/edit-user.png" class="icon-action circ-icon"> </a>
								  </td>
								</tr>
								<tr>
								  <!--<th class="tb-font-black"><input type="checkbox" /></th>-->
							...
							<a href="<s:url value='permissions-edit' />" class="icon-action-link"><img src="includes/images/edit-user.png" class="icon-action circ-icon"> </a>
							</span>
						  </div>		  	
					  </div>
				  </div>
