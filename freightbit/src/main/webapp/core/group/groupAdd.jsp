								...
								<s:iterator value="groupMembers" status="m">
								 <tr>
								  ...
								  <td class="tb-font-black">
									...
									<s:url var="removeUserFromGroupUrl" action="removeUserFromGroupForAdd">
					      ...
					      <tbody>
					         <s:iterator value="users" var="user">
								...
								<!-- 	<a href="#" class="icon-action-link">
									...
									<s:url var="addUserToGroupUrl" action="addUserToGroupForAdd">
								    	<s:param name="userNameParam" value="username"></s:param>
								    	<s:set name="groupCode" value="%{groupBean.groupCode}" scope="session"/>
								    	<s:set name="groupName" value="%{groupBean.groupName}" scope="session"/>
								    	<s:set name="groupDesc" value="%{groupBean.description}" scope="session"/>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-plus"></i> Add New Group</li>
        </ol>
    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-plus"></i> Add New Group</h3>
                </div>
