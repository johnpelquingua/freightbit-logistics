                ...
                <s:form action="editUserProfile" theme="bootstrap" cssClass="form-horizontal" method="post" name="editUserProfileForm">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-3 control-label" id="users-add-label">Company:</label>
                            <div class="col-lg-9">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label" id="users-add-label">Last Name:</label>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label" id="users-add-label">Password:</label>
