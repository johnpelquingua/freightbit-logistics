!function ($) {
    ...
    TabCollapse.DEFAULTS = {
        ...
        accordionTemplate: function(heading, groupId, parentId, active){
            return '<div class="panel panel-default" style="margin-left: 0.3em; margin-right: 0.3em;">' +
                ...
                '        <i class="fa fa-cubes"></i>   ' + heading +
                '        </a>' +
                '      </h4>' +
                '   </div>' +
                '   <div id="' + groupId + '" class="panel-collapse collapse ' + (active ? 'in' : '') + '">' +
                '       <div class="panel-body js-tabcollapse-panel-body" style="padding: 0em; border: none;">' +
                '       </div>' +
                '   </div>' +
                '</div>';
        }
