			...
			<div class="main-box">
				...
				<div class="panel-footer">
					<div class="btn-group" style="float: right;">
						<button class="btn btn-default" onclick="location.href='vendor-contact-person2'">Back</button>
						<button class="btn btn-default" onclick="location.href='vendor-address2'">Next</button>
					</div>
				</div>
                </s:form>
				</div>
