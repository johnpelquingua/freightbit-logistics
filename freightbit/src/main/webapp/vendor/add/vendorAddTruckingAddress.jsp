                ...
                <div class="table-responsive list-table">
                    <s:form action="addTruckingAddress" cssClass="form-horizontal" theme="bootstrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <s:textfield name="address.city" id="address.city" cssClass="vendorAddAddressInput form-control" required="true" maxlength="50"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <s:textfield name="address.zip" id="address.zip" cssClass="vendorAddAddressInput form-control" pattern="^[0-9]{4,}$" maxlength="4" requiredLabel="true" title="Zip Code is required. Must be 4 digits only"/>
                            </div>
                        </div>
