            ...
            <div class="panel booking panel-info">
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Service Details</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <s:select list="serviceReqt" name="servReqt" id="servReqt" cssClass="form-control" onchange="EventChanged(this)" />
                                                </div>
                                            </div>
                                            <div id="service-mode" class="form-group">
                                                <label for="servMode" class="col-sm-5 control-label tb-font-black">Service Mode :</label>
                                                <div class="col-sm-6">
                                                    <s:select list="serviceMode" name="servMode" id="servMode" cssClass="form-control" onchange="EventChanged(this)" />
                                                </div>
                                            </div>
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Shipper Details</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <s:textfield name="bookingNumber" cssClass="form-control" id="bookingNumber" placeholder="Booking Number"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <s:textfield name="shipperPerson" cssClass="form-control" id="shipperPerson" placeholder="Contact Person"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="shipperNumber" class="col-sm-5 control-label tb-font-black">Contact Number:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="shipperNumber" cssClass="form-control" id="shipperNumber" placeholder="Contact Number"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="shipperAddress" class="col-sm-5 control-label tb-font-black">Address:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="shipperAddress" cssClass="form-control" id="shipperAddress" placeholder="Address"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="originPort" class="col-sm-5 control-label tb-font-black">Port of Origin:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="originPort" cssClass="form-control" id="originPort" placeholder="Port of Origin"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="pickupAddress" class="col-sm-5 control-label tb-font-black">Pick-up Address:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="pickupAddress" cssClass="form-control" id="pickupAddress" placeholder="Pick-up Address"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                  ...
                                  <div class="panel-heading">
                                    <h3 class="panel-title">Consignee Details</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <s:textfield name="consigneeName" cssClass="form-control" id="consigneeName" placeholder="Consignee"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="consigneePerson" class="col-sm-5 control-label tb-font-black">Contact Person:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="consigneePerson" cssClass="form-control" id="consigneePerson" placeholder="Contact Person"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="consigneeNumber" class="col-sm-5 control-label tb-font-black">Contact Number:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="consigneeNumber" cssClass="form-control" id="consigneeNumber" placeholder="Contact Number"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="consigneeAddress" class="col-sm-5 control-label tb-font-black">Address:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="consigneeAddress" cssClass="form-control" id="consigneeAddress" placeholder="Address"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="destinationPort" class="col-sm-5 control-label tb-font-black">Port of Destination:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="destinationPort" cssClass="form-control" id="destinationPort" placeholder="Destination Port"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="deliveryAddress" class="col-sm-5 control-label tb-font-black">Delivery Address:</label>
                                            <div class="col-sm-6">
                                                <s:textfield name="deliveryAddress" cssClass="form-control" id="deliveryAddress" placeholder="Delivery Address"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        							  ...
                        							  <div class="panel-heading">
                        								<h3 class="panel-title">Cargo Details</h3>
                        									...
                        									<div class="form-group">
                        										...
                        										<div class="col-sm-6">
                                                                    <s:select list="paymentMode" name="payMode" id="payMode" cssClass="form-control" onchange="EventChanged(this)" />
                        										</div>
                        									</div>
                        									<div class="form-group">
                        										<label for="containQty" class="col-sm-4 control-label tb-font-black">Container Quantity:</label>
                        										<div class="col-sm-6">
                        										    <s:select list="containerQty" name="containQty" id="containQty" cssClass="form-control" onchange="EventChanged(this)" />
                        										</div>
                        								    </div>
                        									<div class="form-group">
                        										<label for="containSize" class="col-sm-4 control-label tb-font-black">Container Size:</label>
                        										<div class="col-sm-6">
                        										    <s:select list="containerSize" name="containSize" id="containSize" cssClass="form-control" onchange="EventChanged(this)" />
                        										</div>
                        								    </div>
                        									<div class="form-group">
                        										<label for="cargoClass" class="col-sm-4 control-label tb-font-black">Cargo Classification:</label>
                        										<div class="col-sm-6">
                        										  <s:textfield name="cargoClass" cssClass="form-control" id="cargoClass" placeholder="Cargo Classification"/>
                        										</div>
                        								    </div>
                        									<div class="form-group">
                        										...
                        										<div class="col-sm-6">
                        										    <div class="input-group">
                        											  <s:textfield name="estWeight" cssClass="form-control" id="estWeight" placeholder="Estimated Weight"/>
                        									...
                        									<div class="form-group">
                        										...
                        										<div class="col-sm-6">
                        											<div class="input-group">
                        											  ...
                        											  <s:textfield name="declaredValue" cssClass="form-control" id="declaredValue" placeholder="Declared Value"/>
                        											</div>
                        										</div>
                        								    </div>
                        									<div class="form-group">
                        										...
                        										<div class="col-sm-6">
                        											<s:textfield name="commDescription" cssClass="form-control" id="commDescription" placeholder="Commodity Description"/>
                        										</div>
                        								    </div>
                        									<div class="form-group">
                ...
                <div class="panel-footer">
                    ...
                    <span class="pull-right">
                        <button type="button" class="btn new-booking" data-toggle="modal" data-target="#booking-search" onclick="location.href='Booking-Search'">
                              Cancel
                        </button>
