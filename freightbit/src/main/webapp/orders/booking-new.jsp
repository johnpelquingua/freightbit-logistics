...
<div class="tab-pane fade in active" id="details">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4" >
            <input type="text" class="from_date form-control" id="orderBean.pickupDate" name="orderBean.pickupDate" placeholder="Select start date" contenteditable="false" style="margin-bottom: 15px !important;">
        ...
        <div class="col-lg-4" >
            <input type="text" class="to_date form-control" id="orderBean.deliveryDate" name="orderBean.deliveryDate" placeholder="Select end date" contenteditable="false" style="margin-bottom: 15px !important;">
        </div>
