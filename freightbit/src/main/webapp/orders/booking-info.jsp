        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield cssClass="form-control" id="serviceReqt" name="serviceReqt"
                                     placeholder="Service Requirement"></s:textfield>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield cssClass="form-control" id="serviceMode" name="serviceMode"
                                     placeholder="Service Mode"></s:textfield>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield cssClass="form-control" id="bookingDate" name="bookingDate"
                                     placeholder="Booking Date"></s:textfield>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield cssClass="form-control" id="bookingNumber" name="bookingNumber"
                                     placeholder="Booking Number"></s:textfield>
                    </div>
                </div>
                </form>
            </div>
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="bAddress" name="bAddress"
                                         placeholder="Address"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="contactPerson" name="contactPerson"
                                         placeholder="Contact Person"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="originPort" name="originPort"
                                         placeholder="Port of Origin"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="pickupAddress" name="pickupAddress"
                                         placeholder="Pick-up Address"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="pickupDate" name="pickupDate"
                                         placeholder="Pick-up Date"></s:textfield>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="destinationPort" class="col-sm-4 control-label tb-font-black">Port of
                            Destination:</label>

                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="destinationPort" name="destinationPort"
                                         placeholder="Port of Destination"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="deliveryAddress" class="col-sm-4 control-label tb-font-black">Delivery
                            Address:</label>

                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="deliveryAddress" name="deliveryAddress"
                                         placeholder="Delivery Address"></s:textfield>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <s:textfield cssClass="form-control" id="deliveryDate" name="deliveryDate"
                                         placeholder="Delivery Date"></s:textfield>
                        </div>
                    </div>
                </form>
            </div>
