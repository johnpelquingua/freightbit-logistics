        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <s:textfield cssClass="form-control" id="keyword" name="keyword"
                                     placeholder="Keyword"></s:textfield>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label ">Date From:</label>
         ...
         <button type="button" class="btn btn-info" onclick="location.href='viewOrders'">
             Search
         </button>
         </span>
            </div>
