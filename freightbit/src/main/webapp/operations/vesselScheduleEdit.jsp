					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="voyagenum" value="MTY-1035">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="time" class="form-control" id="timeOfdep" value="14:00">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="date" class="form-control" id="dateOfdep" value="2014-06-19">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="date" class="form-control" id="dateOfarv" value="2014-06-22">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="Origin" value="MANILA">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="Origin" value="CEBU">
							    </div>
						...
						<div style="float: right;">
							<button class="btn btn-default" onclick="location.href='#'">Save</button>
