                    ...
                    <s:form action="updateStatusOfContainers" theme="bootstrap">
                        ...
                        <display:table id="orderItems" name="orderItemsBeans"
                            ...
                            <td><display:column property="port" title="Port <i class='fa fa-sort' />" class="tb-font-black"
                                                style="text-align: center;"> </display:column></td>
                            <%--<td><display:column property="orderItemId" title="Port <i class='fa fa-sort' />" class="tb-font-black"
                                                style="text-align: center;"> </display:column></td>--%>
                            <%--<s:hidden name="orderItemIdParam" value="%{#attr.orderItemsInsideContainer.orderItemId}"></s:hidden>--%>
                        </display:table>
