                        ...
                        <div class="table-responsive list-table">
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="inlineCheckbox1" value="option1"> Date of
                                            Departure
                                        </label>
                                        <label class="checkbox-inline">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="inlineCheckbox3" value="option3"> Pier
                                            Destination
                                        </label>
                                    </div>
                                ...
                                <button type="cancel" class="btn btn-default"
                                        style="float:right;margin:6px 0px 6px 0px;" id="groups-btn">Cancel
                                </button>

                                <a href="vessel-schedule-list.html" class="btn btn-default"
                                   style="float:right;margin:6px 20px 6px 0px;" id="groups-btn">Search</a>
