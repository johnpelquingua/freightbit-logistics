...
<div class="panel-body">
    ...
    <h4>Are you sure you want to assign container(s) to this trucking vendor?</h4><br />
        ...
        <h4 style="text-align:center; margin-bottom: 20px;"> Trucking Vendor Destination <i class="fa fa-flip-horizontal fa-truck"></i></h4>
        ...
        <div class="col-lg-9">
            <s:textfield cssClass="form-control dispatch-form" value="%{finalDeliveryParam}"  />
        </div>
        ...
        <div class="pull-right">
            ...
            <s:url var="editOrderItemsDispatchUrl" action="editOrderItemsDestinationModal">
                ...
                <s:param name="finalDeliveryParam"
                         value="finalDeliveryParam">
                </s:param>
