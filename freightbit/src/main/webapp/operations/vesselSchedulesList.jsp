				...
				<div class="col-md-12">
				    <div class="panel booking panel-info">
								...
								<tbody>
									<tr class="success">
									  ...
									  <td class="tb-font-black">
										<a href="vessel-schedule-edit.html" class="icon-action-link edit-booking"><img src="images/edit-booking.png" class="icon-action circ-icon" title="Edit Schedule"> </a>
										<a href="#delete-Schedule" class="icon-action-link delete-booking"><img src="images/delete-sched.png" class="icon-action circ-icon" title="Delete Schedule"> </a>
									  </td>									  									  
									</tr>
						...
						<div class="panel-footer">
							...
							<a href="vessel-schedule-add.html" class="icon-action-link"><img src="images/add-sched.png" class="icon-action circ-icon"> </a>
							</span>
						</div>
				    </div>
			    </div>	
