...
<div class="table-responsive list-table">
				...
				<s:form  action="edit_finance_validate" cssClass="form-horizontal" theme="bootstrap">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10" style="width:70%;">
					  <s:textfield name="contact" cssClass="form-control" id="contact" placeholder="Contact Number"/>
					</div>
				  </div>
				  <span class="pull-right" style="margin-right:32px;">
					<a href="javascript: window.history.back();" class="btn btn-default" id ="groups-btn" style="width:70px;">Back</a>
