...
<%------------------------------------------COMPLETE DOCUMENTS BEGIN-----------------------------------------------%>
                            ...
                            <div class="table-responsive" style="clear:both;">
                                ...
                                <display:table id="document" name="archiveDocuments" requestURI="viewOrderDocumentsArchived.action" pagesize="50" class="final_inbound_table table table-striped table-hover table-bordered text-center tablesorter"
                                               style="margin-top: 15px;">

                                    <%--<td>--%>

                                            <%--<display:column title="" class="tb-font-black" style="text-align: center;" >--%>
                                            <%--&lt;%&ndash;<display:column title="<input type='checkbox' id='fiCheckBox' />" class="tb-font-black" style="text-align: center;" >&ndash;%&gt;--%>

                                                <%--&lt;%&ndash;<s:if test=" documentTabComplete == 'COMPLETE_STAGE_ACTIVE' ">&ndash;%&gt;--%>

                                                    <%--<s:if test="#attr.document.documentProcessed <= 4">--%>
                                                        <%--<s:checkbox theme="simple" name="check" fieldValue="%{#attr.document.documentId}"/>--%>
                                                        <%--&lt;%&ndash;<s:url var="checkDocumentCompleteUrl" action="checkDocumentComplete">--%>
