...
<div class="row">
    <div class="col-lg-12" >
        <legend style="text-align: left;">
            <span >
                <h1><i class="fa fa-file-text"></i>  Acceptance Receipt </h1>
            </span>
        </legend>
    </div>
    <!-- MAIN BOX -->
    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="booking panel-heading">
                ...
                <span class="booking panel-title">Acceptance Receipt</span>
            </div>
            <div class="panel-body">
                <div class="table-responsive list-table">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="container" class="col-sm-2 control-label" style="width:25%;">Container
                                Number</label>
