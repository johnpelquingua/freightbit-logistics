...
<legend style="text-align: left;">
    <span >
       <h1><i class="fa fa-clipboard"></i> Reports : FCL Operations </h1>
    </span>
</legend>

<div class="panel panel-primary">
    <div class="panel-heading">
        FCL Operations Report
    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <s:select cssClass="form-control" style="margin-bottom: 15px !important;"
                                      id="dataIdStat" list="FCL_statisticsList" listKey="key"
...
//                submitForm.submit();
    ...
    function generateStatistics() {
        ...
        win.onload = function () {
            if (dataVal == "TOTAL FCL BOOKINGS") {
                this.document.title = "Total FCL Bookings";
            }
        }
    }
