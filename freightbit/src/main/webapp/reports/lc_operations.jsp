...
<legend style="text-align: left;">
    <span >
       <h1><i class="fa fa-clipboard"></i> Reports : Loose Cargo Operations </h1>
    </span>
</legend>

<div class="panel panel-primary">
    <div class="panel-heading">
        Loose Cargo Operations Report
    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <s:select cssClass="form-control" style="margin-bottom: 15px !important;"
                                      id="dataIdStat" list="LC_statisticsList" listKey="key"
...
//                submitForm.submit();
    ...
    function generateStatistics() {
        ...
        win.onload = function () {
            if (dataVal == "TOTAL NUMBER OF LC BOOKINGS") {
                this.document.title = "Total Number of LC Bookings";
            }
        }
    }
