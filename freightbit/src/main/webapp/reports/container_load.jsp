...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div style="height:100%;" class="panel booking panel-info">
                    <div style="height:55px;"class="booking panel-heading">
                        ...
                        <span id="LessContainerLoad" style="display:none" class="booking panel-title"><strong>Less Container Load</strong></span>
                        <img id="containerNext" src="includes/images/right.png" height="25" class="box-icon" style="margin-left:10px;"/>
                    </div>
