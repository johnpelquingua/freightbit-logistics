    ...
    <%@ taglib prefix="sj" uri="/struts-jquery-tags" %>
       ...
       <head>
          ...
          <style type="text/css">
            #reportmenu{ border-bottom: 3px #FFCC00 solid; }
            #reportmenu:hover ,#transactionmenu:hover, #statisticsmenu:hover { border-bottom: 3px #FFCC00 solid;}
...
<hr>
 ...
 <div id="chart_div" style="background-color:transparent; margin-left:-15px; width: 1100px; height: 500px;"></div> <!-- LINE GRAPH -->
</div>              <!-- FTL REPORT END -->
