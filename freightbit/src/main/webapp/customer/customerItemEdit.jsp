...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <div class="main-box">
    <div class="panel booking panel-info">
      <div class="booking panel-heading"> <img src="images/add-user.png" class="box-icon"> <span class="booking panel-title">Edit - Items</span> </div>
      <div class="panel-body">
        <div class="table-responsive list-table">
          <s:form cssClass="form-horizontal" theme="bootstrap" action="customerEditItem">
            <s:hidden name="item.customerItemsId" value="%{item.customerItemsId}" />
