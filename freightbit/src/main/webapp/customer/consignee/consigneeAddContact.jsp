                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10" >
                                                    <s:textfield cssClass="form-control" placeholder="(XXX) XXX-XXXX" name="consigneeContact.fax" id="contact_fax" pattern=".{14,}"
                                                                 maxLength="14"  title="Fax number should contain 10 digits including local city codes."/>
                                                </div>
                                            </div>
                                        </div>
