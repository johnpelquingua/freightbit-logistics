        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="table-responsive list-table">
                    ...
                    <div class="form-group">
                        ...
                        <label for="VESSEL_NUMBER" class="col-sm-2 control-label">Vessel:</label>

                        <div class="col-sm-10">
                            <s:textfield cssClass="form-control" id="VESSEL_NUMBER" placeholder="Vessel Number" name="VESSEL_NUMBER"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="VESSEL_NAME" class="col-sm-2 control-label">Name:</label>

                        <div class="col-sm-10">
                            <s:textfield cssClass="form-control" id="VESSEL_NAME" placeholder="Vessel Name" name="VESSEL_NAME"/>
                        </div>
            ...
            <div class="panel-footer">
                ...
                <div class="btn-group pull-right">
                    <button class="btn btn-default" onclick="location.href='vendor-list-info'">Cancel</button>
                    <button class="btn btn-default" onclick="location.href='vendor-list-info'">Save</button>
                </div>
            </div>
            </s:form>
        </div>
