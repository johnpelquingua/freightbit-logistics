    ...
    <div style="float:left;">
        <div style=" width:250px;float:left;margin-left:70px; ">
                     <div id="FullTruckLoad" class="divbox" style="float:left">
                       <center style="margin-top:-10px; margin-bottom:20px;"><h5><strong>Full Truck Load</strong><h5></center>
            ...
            <div style=" width:250px;float:left;margin-left:70px; ">
             ...
             <div style="float:left;" >
                 <div style=" width:250px;;margin-left:70px; ">
                       ...
                       <center style="margin-top:-15px; margin-bottom:25px;"><h5><strong>Sales</strong><h5></center>
                       ...
                       <center style="margin-top:-10px; margin-bottom:20px;"><h5><strong>Customer Relation</strong><h5></center>
...
<!-- FTL -->
  ...
  <h2 style="margin-left:10px;">Full Truck Load</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
     <hr>
...
<div class="menu2" id="RCargo" style="display:none; height:200px; margin-top:-20px;" >
  <h2 style="margin-left:10px;">Rolling Cargo</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
     <hr>
         <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                        <div  style="margin-left:10px; padding-top:15px">
                                        <img src="includes/images/booking.png" class="box-icon">
...
<div class="menu2" id="LCargo" style="display:none; height:200px; margin-top:-20px;" >
  <h2 style="margin-left:10px;">Loose Cargo</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
  <hr>
 <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                <div  style="margin-left:10px; padding-top:15px">
                                <img src="includes/images/booking.png" class="box-icon">
...
<!-- FCL -->
 ...
 <h2 style="margin-left:10px;">Full Container Load</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
     <hr>
 <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                <div  style="margin-left:10px; padding-top:15px">
                                <img src="includes/images/booking.png" class="box-icon">
...
<!-- LCL -->
 ...
 <h2 style="margin-left:10px;">Less Container Load</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
     <hr>
 <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                <div  style="margin-left:10px; padding-top:15px">
                                <img src="includes/images/booking.png" class="box-icon">
...
<!-- CR -->
  <div class="menu2" id="CR" style="display:none; height:200px; margin-top:-20px;" >
    <h2 style="margin-left:10px;">Customer Relations</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
     <hr>
 <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                <div  style="margin-left:10px; padding-top:15px">
                                <img src="includes/images/booking.png" class="box-icon">
...
<div style="display:none; height:200px; margin-top:-20px;"  id="Sale" class="menu2" >
  <h2 style="margin-left:10px;">Sales</h2> <a class="btn btn-default back" style="float:left; margin-left:10px;" href="#">Back</a>
      <hr>
        <div  class="selection" style=" background-color: #f1eb49;margin-left:10px; float:left">
                                <div  style="margin-left:10px; padding-top:15px">
                                <img src="includes/images/booking.png" class="box-icon">
