...
<!-- HERE -->
		            ...
		            <div class="form-group">
		                ...
		                <s:textfield disabled="true" cssStyle="margin-bottom:5px;margin-right:5px" name="groupBean.groupCode"  size="80"   />
		             </div>

		            <div class="form-group">
		                <label for="name" class="col-sm-2 control-label">Name:</label>
		                <s:textfield disabled="true" cssStyle="margin-bottom:5px;margin-right:5px" name="groupBean.groupName"   size="80"/>
		            </div>

		            <div class="form-group">
		                <label for="Description" class="col-sm-2 control-label">Description:</label>
		                <s:textfield disabled="true" cssStyle="margin-bottom:5px; margin-right:5px" name="groupBean.description" size="80"  />
		            </div>
						...
						<table class="table table-striped table-bordered text-center" id="users-list">
					      ...
					      <tbody>
					         <s:iterator value="users" var="user">
								...
								<!-- 	<s:url var="addUserToGroupUrl" action="addUserToGroup">
