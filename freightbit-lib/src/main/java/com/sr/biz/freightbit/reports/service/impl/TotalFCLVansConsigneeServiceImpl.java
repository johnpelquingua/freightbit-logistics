...
import com.sr.biz.freightbit.reports.service.TotalFCLVansConsigneeService;
 ...
 */
public class TotalFCLVansConsigneeServiceImpl extends ReportGeneratorService implements TotalFCLVansConsigneeService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/FCL_Total_Container_Vans_per_consignee.prpt");
