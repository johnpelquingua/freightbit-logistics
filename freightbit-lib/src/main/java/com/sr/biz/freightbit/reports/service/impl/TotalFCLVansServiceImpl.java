...
import com.sr.biz.freightbit.reports.service.TotalFCLVansService;
 ...
 */
public class TotalFCLVansServiceImpl extends ReportGeneratorService implements TotalFCLVansService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/FCL_Total_Container_Vans.prpt");
