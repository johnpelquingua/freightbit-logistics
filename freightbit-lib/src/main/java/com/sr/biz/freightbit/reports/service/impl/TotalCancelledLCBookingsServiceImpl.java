...
import com.sr.biz.freightbit.reports.service.TotalCancelledLCBookingsService;
 ...
 */
public class TotalCancelledLCBookingsServiceImpl extends ReportGeneratorService implements TotalCancelledLCBookingsService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/LC_Total_Number_Of_Cancelled_Bookings.prpt");
