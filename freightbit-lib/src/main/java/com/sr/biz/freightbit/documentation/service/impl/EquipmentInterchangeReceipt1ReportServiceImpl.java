...
import com.sr.biz.freightbit.documentation.service.EquipmentInterchangeReceipt1ReportService;
...
public class EquipmentInterchangeReceipt1ReportServiceImpl extends ReportGeneratorService implements EquipmentInterchangeReceipt1ReportService {
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/EIR1.prpt");
