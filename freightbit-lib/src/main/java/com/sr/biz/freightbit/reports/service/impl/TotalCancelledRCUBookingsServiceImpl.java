...
import com.sr.biz.freightbit.reports.service.TotalCancelledRCUBookingsService;
 ...
 */
public class TotalCancelledRCUBookingsServiceImpl extends ReportGeneratorService implements TotalCancelledRCUBookingsService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/RCU_Total_Number_Of_Cancelled_Bookings.prpt");
