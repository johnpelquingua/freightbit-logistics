...
import com.sr.biz.freightbit.reports.service.TotalBookingsService;
 ...
 */
public class TotalBookingsServiceImpl extends ReportGeneratorService implements TotalBookingsService {
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/CRS_Total_Number_Of_Bookings.prpt");
