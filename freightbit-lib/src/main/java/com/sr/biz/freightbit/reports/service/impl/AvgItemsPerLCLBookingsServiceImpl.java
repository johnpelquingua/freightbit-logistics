...
import com.sr.biz.freightbit.reports.service.AvgItemsPerLCLBookingsService;
...
public class AvgItemsPerLCLBookingsServiceImpl extends ReportGeneratorService implements AvgItemsPerLCLBookingsService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/LCL_Avg_Number_Of_Items_per_shipper_per_port.prpt");
