...
import com.sr.biz.freightbit.reports.service.TotalFCLVansShipperPortService;
 ...
 */
public class TotalFCLVansShipperPortServiceImpl extends ReportGeneratorService implements TotalFCLVansShipperPortService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/FCL_Total_Number_Of_Bookings_per_port.prpt");
