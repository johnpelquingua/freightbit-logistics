...
import com.sr.biz.freightbit.reports.service.TotalCancelledLCLBookingsService;
 ...
 */
public class TotalCancelledLCLBookingsServiceImpl extends ReportGeneratorService implements TotalCancelledLCLBookingsService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/LCL_Total_Number_Of_Cancelled_Bookings.prpt");
