...
public class VesselSchedules implements Serializable{
    ...
    public VesselSchedules(Integer vesselScheduleId, Integer clientId, Integer vendorId,
                           String originPort, Date departureDate, Date departureTime,
                           String destinationPort, Date arrivalDate, Date arrivalTime,
