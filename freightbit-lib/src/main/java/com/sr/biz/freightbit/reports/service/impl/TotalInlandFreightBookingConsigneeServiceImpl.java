...
import com.sr.biz.freightbit.reports.service.TotalInlandFreightBookingConsigneeService;
 ...
 */
public class TotalInlandFreightBookingConsigneeServiceImpl extends ReportGeneratorService implements TotalInlandFreightBookingConsigneeService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/TKG_Total_Number_Of_Bookings_per_consignee.prpt");
