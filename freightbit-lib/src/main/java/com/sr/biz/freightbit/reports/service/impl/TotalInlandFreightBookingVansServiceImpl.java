...
import com.sr.biz.freightbit.reports.service.TotalInlandFreightBookingVansService;
 ...
 */
public class TotalInlandFreightBookingVansServiceImpl extends ReportGeneratorService implements TotalInlandFreightBookingVansService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/TKG_Total_Container_Vans_Per_Inland_Freight_Booking_Per_Shipper.prpt");
