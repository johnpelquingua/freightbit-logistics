...
import com.sr.biz.freightbit.reports.service.TotalSchedulePerVendorPerDestinationService;
...
public class TotalSchedulePerVendorPerDestinationServiceImpl extends ReportGeneratorService implements TotalSchedulePerVendorPerDestinationService{
    public MasterReport getReportDefinition()
    {
        try
        {
            ...
            final URL reportDefinitionURL = classVar.getResource("/reports/LCL_Total_Schedule_per_vendor_per_port.prpt");
